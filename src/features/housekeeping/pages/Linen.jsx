                ...
                <div className="mb-4">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="p-2.5 rounded-xl bg-[var(--color-primary)]/10">
                            <BedDouble className="w-6 h-6 text-[var(--color-primary)]" />
                        </div>
                        <h1 className="text-xl font-semibold text-[var(--color-text-primary)]">Housekeeping</h1>
                    </div>
                    <p className="text-[var(--color-text-secondary)]">Lenceria (en desarrollo)</p>
                </div>
